                ...
                <div class="x_panel tile">
                    <div class="x_title">
                        <div class="page-header">
                            <h1>Edit Product in {{$product->store_name}}</h1>
                    ...
                    <div class="x_content">
                        ...
                        <form role="form" method="post" id="productform" action="/product/{{$product->id}}/update">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control editor-wrapper col-md-7"
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="number" name="amount" class="form-control"
                                           value="{{$product->amount}}" required="required">
                                </div>
                                <br/>
                                <br>
                                ...
                                <iframe width="300" height="300" src="https://www.youtube.com/embed/{{$product->youtube_id}}" frameborder="0" allowfullscreen></iframe>
